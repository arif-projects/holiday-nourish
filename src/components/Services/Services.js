...
const Services = () => {
    ...
    useEffect(() => {
        fetch('https://holidaynourish.herokuapp.com/services')
            .then(res => res.json())
                                ...
                                <div className="col-md-4 mb-5">
                                    <div className="card">
                                        ...
                                        <div className="card-text">
                                            ...
                                            <Link to={`/check/${pd.id}`} style={{ textDecoration: 'none' }}>
                                                <button className="discover-button d-flex align-items-end">Book now</button>
                                            </Link>
